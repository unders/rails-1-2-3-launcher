...
Then /^I should see error messages$/ do
  ...
  with_scope('form') { assert has_content?('Password doesn\'t match confirmation') }
end
...
Given /^I am signed up and confirmed as "(.*)\/(.*)"$/ do |email, password|
  User.make(:email => email, :password => password, :password_confirmation => password).confirm_email!
end
...
Then /^I should be signed out$/ do
  # assert ! controller.signed_in?
   with_scope('form > fieldset.buttons') { assert find_button('Sign in') }
end
